...
function copyJsVendors(cb) {
  if (options.copyJsVendors) {
    return src([
      ...
      // 'node_modules/fontawesome-free/js/fontawesome.min.js'
    ])
...
function copyFontAwesome5Fonts() {
  return src('src/webfonts/*.*').pipe(
    dest(dir.build + 'webfonts/')
  );
}
exports.copyFontAwesome5Fonts = copyFontAwesome5Fonts;
